...
def taxi_zones() -> None:
    """
    Insert taxi zone data into database
    """
    query = """
        create or replace table zones as (
        select LocationID AS zone_id, zone, borough, the_geom as geometry from 'data/raw/taxi_zones.csv'
        );
    """
    conn = backoff(
        fn=duckdb.connect,
